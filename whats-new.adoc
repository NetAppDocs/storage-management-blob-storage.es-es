...
summary: Descubra las novedades de Azure Blob Storage en la consola de NetApp . 
---
= Novedades de Azure Blob Storage en la consola de NetApp
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Descubra las novedades de Azure Blob Storage en la consola de NetApp .
